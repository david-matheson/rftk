...
if sys.platform == 'linux2':
    _train = Extension("_train",
                       ...
                       "RandomThresholdHistogramDataCollector.cpp",
                       "TwoStreamRandomThresholdHistogramDataCollector.cpp",
                       "OfflineSplitCriteria.cpp",
                       "OnlineAlphaBetaSplitCriteria.cpp",
                       "OnlineConsistentSplitCriteria.cpp"],
