...
BUFFER_TYPE& Get ## BUFFER_TYPE(const std::string& name);
    ...
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Float64VectorBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int32VectorBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int64VectorBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Float32MatrixBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Float64MatrixBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int32MatrixBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int64MatrixBuffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Float32Tensor3Buffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Float64Tensor3Buffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int32Tensor3Buffer)
    DECLARE_BUFFER_LEGACY_INTERFACE_FOR_TYPE(Int64Tensor3Buffer)
