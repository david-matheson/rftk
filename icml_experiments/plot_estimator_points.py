...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Plot number of estimator points data')
    ...
    plot_utils.plot_total_estimator_points(data_config.data_sizes, data_config.number_of_passes_through_data,
